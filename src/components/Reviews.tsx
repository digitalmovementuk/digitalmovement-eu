  ...
  return (
    ...
    >
            ...
            <div className="lg:justify-self-end">
              <div className="flex items-center justify-center lg:justify-start gap-2.5">
                ...
                <p className="text-[15px] sm:text-[17px] text-ink-soft leading-tight">
                  <span className="font-semibold text-ink">5,0 im Schnitt</span> aus{" "}
                  <span className="font-semibold text-ink">über 100 verifizierten Bewertungen</span>.
                </p>
              </div>
      ...
      <div className="container-v3 mt-8 sm:mt-10 flex items-center justify-center gap-2.5 sm:gap-3">
        <div className="flex items-center gap-1 sm:gap-1.5 rounded-full bg-ink/[0.10] backdrop-blur-md px-2.5 py-1.5 sm:px-3 sm:py-2">
          {testimonials.map((r, i) => (
            <button
              ...
              type="button"
              onClick={() => goTo(i)}
              aria-label={`Zur Bewertung von ${r.name}`}
        ...
        <button
          type="button"
          aria-label={paused ? "Weiterlaufen lassen" : "Anhalten"}
